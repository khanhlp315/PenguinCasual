...
// using UnityEngine;
//
// //from: TMP_BaseEditorPanel
//
// namespace TMPro.EditorUtilities
// {
// 	public abstract class TagAction_TMP_BaseEditorPanel : Editor
// 	{
// 		//Labels and Tooltips
...
//
//
// 		protected SerializedProperty m_TagActionTextProp;
// 		protected SerializedProperty m_tagManagerProp;
// 		protected UGUITagActionText.TagActionTMPUGUI m_TagActionmTextComponent;
//
//
...
// 		{
//
// 			m_TagActionTextProp = serializedObject.FindProperty("m_tagActionText");
// 			m_tagManagerProp = serializedObject.FindProperty("m_tagManager");
// 			m_TagActionmTextComponent = (UGUITagActionText.TagActionTMPUGUI)target;
//
...
//
// 			//DrawTextInput();
// 			DrawTagActionTextInput();
// 			EditorGUILayout.Space();
// 			EditorGUI.BeginChangeCheck();
// 			EditorGUILayout.PropertyField(m_tagManagerProp, new GUIContent("Tag Manager"));
// 			if (EditorGUI.EndChangeCheck())
// 			{
// 				m_TagActionmTextComponent.TagManager = m_tagManagerProp.objectReferenceValue as UGUITagActionText.TagActionManager;
// 				m_TextProp.stringValue = m_TextComponent.text;
// 			}
//
//
//
...
// 		}
//
// 		protected void DrawTagActionTextInput()
// 		{
// 			EditorGUILayout.Space();
//
...
// 				EditorGUI.BeginChangeCheck();
//
// 				EditorGUILayout.PropertyField(m_TagActionTextProp, new GUIContent("Text"));
// 				//EditorGUILayout.PropertyField(m_TextProp, new GUIContent("tmpText"));
// 				m_IsRightToLeftProp.boolValue = EditorGUILayout.Toggle(k_RtlToggleLabel, m_IsRightToLeftProp.boolValue);
//
// 				if (EditorGUI.EndChangeCheck() || m_IsRightToLeftProp.boolValue) //(m_IsRightToLeftProp.boolValue && string.IsNullOrEmpty(m_RtlText)))
// 				{
//
// 					m_TagActionmTextComponent.tagActionText = m_TagActionTextProp.stringValue;
// 					//m_TagActionmTextComponent.RePaint();
// 					m_TextProp.stringValue = m_TextComponent.text;
//
//
...
// 					{
// 						m_TagActionmTextComponent.m_RtlTagActionText = string.Empty;
// 						string sourceText = m_TagActionTextProp.stringValue;
// 						for (int i = 0; i < sourceText.Length; i++)
// 						{
// 							m_TagActionmTextComponent.m_RtlTagActionText += sourceText[sourceText.Length - i - 1];
// 						}
// 						
...
// 				{
// 					EditorGUI.BeginChangeCheck();
// 					m_TagActionmTextComponent.m_RtlTagActionText = EditorGUILayout.TextArea(m_TagActionmTextComponent.m_RtlTagActionText, TMP_UIStyleManager.wrappingTextArea, GUILayout.Height(EditorGUI.GetPropertyHeight(m_TagActionTextProp) - EditorGUIUtility.singleLineHeight), GUILayout.ExpandWidth(true));
// 					if (EditorGUI.EndChangeCheck())
// 					{
// 						string sourceText = string.Empty;
// 						for (int i = 0; i < m_TagActionmTextComponent.m_RtlTagActionText.Length; i++)
// 						{
// 							sourceText += m_TagActionmTextComponent.m_RtlTagActionText[m_TagActionmTextComponent.m_RtlTagActionText.Length - i - 1];
// 						}
// 						m_TagActionTextProp.stringValue = sourceText;
// 						m_TagActionmTextComponent.tagActionText = m_TagActionTextProp.stringValue;
// 						//m_TagActionmTextComponent.RePaint();
// 						m_TextProp.stringValue = m_TextComponent.text;
//
// 						sourceText = m_TextProp.stringValue;
// 						for (int i = 0; i < sourceText.Length; i++)
// 						{
// 							m_RtlText += sourceText[sourceText.Length - i - 1];
// 						}
