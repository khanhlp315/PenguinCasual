...
//
// //from: TMP_UiEditorPanel
//
// namespace TMPro.EditorUtilities
// {
//
// 	[CustomEditor(typeof(UGUITagActionText.TagActionTMPUGUI)), CanEditMultipleObjects]
// 	public class TagAction_TMP_UiEditorPanel : TagAction_TMP_BaseEditorPanel
// 	{
...
// 				{
// 					if(objects[i].GetComponent<UGUITagActionText.TagActionTMPUGUI>() == null)
// 						return true;
// 				}
// 			}
// 			return false;
...
// 					TMPro_EventManager.ON_TEXTMESHPRO_UGUI_PROPERTY_CHANGED(true, targets[i] as UGUITagActionText.TagActionTMPUGUI);
