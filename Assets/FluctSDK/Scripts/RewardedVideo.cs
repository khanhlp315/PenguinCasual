...
namespace Fluct
{
...
#endif
    {
        ...
        private static extern void _FluctPlugin_RewardedVideo_Load(string groupId, string unitId, string userId, int gender, string birthday, int age);
        [DllImport("__Internal")]
        ...
        private void _FluctPlugin_RewardedVideo_Load(string groupId, string unitId, string userId, int gender, string birthday, int age)
        {
            androidJavaObject.Call("loadAd", groupId, unitId, userId, gender, birthday, age);
        }
        ...
        public void Load(AdRequestTargeting targeting)
        {
            ...
            _FluctPlugin_RewardedVideo_Load(groupId, unitId, targeting.UserId, (int)targeting.Gender, targeting.getBirthdayString(), targeting.Age);
        }
